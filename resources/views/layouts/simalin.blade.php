...
<div class="wrapper">
    <header class="main-header">
        <!-- Logo untuk mobile-->
        <a href="{{ route('/') }}" class="logo hidden-md hidden-lg" style="background: #2a3b48;">
            ...
            <nav class="navbar navbar-static-top" style="background-color: #2a3b48">
                <div class="container">
                    <div class="navbar-header">
                        <a href="{{ route('/') }}" class="navbar-brand hidden-sm hidden-xs"><i class="fa fa-phone-square"></i> SiMALIN</a>
            ...
            <nav class="navbar navbar-static-top" style="background-color: #2a3b48">
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
                        ...
                        <form class="navbar-form navbar-left cekmalin" role="search" method="post">
                            {{ csrf_field() }}
                            <div class="form-group">
                                <input name="no_track" type="text" class="form-control notrack" id="malin-search-input" placeholder="Cek laporan...">
                            </div>
                        </form>
                        <script src="{{ url('/assets/plugins/jQuery/jquery-2.2.3.min.js') }}"></script>
                        <script>
                            $(document).ready(function () {
                                $(document).on('change','.notrack',function () {
                                    var text = document.getElementById('malin-search-input').value;
                                    var action = "/cek/"+text;
                                    console.log(action);
                                    $('.cekmalin').attr('action',action);
                                });
                            });
                        </script>
                    </div>
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            @else
                                <li class="dropdown hidden-sm hidden-xs">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">{{ ucfirst(Auth()->user()->getNamaDepan()) }} <span class="caret"></span></a>
